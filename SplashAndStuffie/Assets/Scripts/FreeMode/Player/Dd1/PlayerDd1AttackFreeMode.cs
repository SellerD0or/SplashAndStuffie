...
public class PlayerDd1AttackFreeMode : PlayerAttackFreeMode
{
    ...
    private IEnumerator Create()
    {
            ...
            PlayerDd1BulletFreeMode butllet = Instantiate(_bullet,_shotPosition.position,Quaternion.identity );
            Debug.Log("Shoot");
