...
[RequireComponent(typeof(PlayerDd2Attack))]
[RequireComponent(typeof(CharacterChangerState))]
[RequireComponent(typeof(PlayerDd2Animator))]
[RequireComponent(typeof(PlayerDd2Ability))]
public class Dd2 : Player, IDamageable
{
  ...
  [SerializeField] private Sprite _icon;
    ...
    private void Awake() {
        Ability = GetComponent<PlayerDd2Ability>();
        IPlayerAttackable = GetComponent<PlayerDd2Attack>();
        IPlayerAttackable.SetPlayer(this);
        IPlayerAnimator = GetComponent<PlayerDd2Animator>();
