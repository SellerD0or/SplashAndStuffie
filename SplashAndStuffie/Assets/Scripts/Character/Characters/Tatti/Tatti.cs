...
[RequireComponent(typeof(PlayerTattiAttack))]
[RequireComponent(typeof(PlayerTattiAnimator))]
[RequireComponent(typeof(PlayerTattiAbility))]
public class Tatti : Player
{
  ...
  [SerializeField] private Sprite _barIcon;
    ...
    private void Awake() {
      ...
      IHealthOutPut = FindObjectOfType<Dd1HealthOutPut>();
        IPlayerAttackable = GetComponent<PlayerTattiAttack>();
        IPlayerAttackable.SetPlayer(this);
        IPlayerAnimator = GetComponent<PlayerTattiAnimator>();
        CharacterChangerState = GetComponent<CharacterChangerState>();
        Ability = GetComponent<PlayerTattiAbility>();
