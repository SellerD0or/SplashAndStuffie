...
public class PlayerBomberAnimator : MonoBehaviour, IPlayerAnimator
{
  ...
  public void MakeDeathSound()
   ...
   public void PlayAttack()
    ...
    public void SwitchStates()
    {
       ...
       {
           Invoke(nameof(Jump),1.4f);
          Invoke(nameof(TakeOff),2.5f);
         //  playerAudioSourse1.AudioSource.Play();
    ...
    {
        PlayerAudioSourse playerAudioSourse1 = Instantiate(_playerAudioSourse,transform.position,Quaternion.identity);
          playerAudioSourse1.AudioSource.clip = _audioClips[3];
           playerAudioSourse1.AudioSource.Play();
    }
     private void Stay()
   {
