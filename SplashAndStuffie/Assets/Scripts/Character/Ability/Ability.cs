...
public abstract class Ability : MonoBehaviour
{
  ...
  [SerializeField] private float _timeForRemovingAbility;
   public float TimeForRemovingAbility { get => _timeForRemovingAbility; set => _timeForRemovingAbility = value; }
  public abstract int CurrentTime {get;set;}
  public abstract float CoolDown {get;set;}
  public abstract Player Player {get;set;}
  public abstract void UseAbilitiy();
  public abstract void DisactiveAbility();
  public abstract bool IsCoolDown{get;set;}
  public abstract IEnumerator Reload();
  public bool IsStoppeUsingAbility{get;set;}
  public abstract ParticleSystem ParticleSystem{get;set;}
  public abstract float LastedTime {get;set;}
    ...
    {
      Debug.LogError("COOL" + " RELOAD !!!");
            CurrentTime ++;
              LastedTime = CoolDown - CurrentTime;
                      OnUploadAmount?.Invoke();

                if (CurrentTime > TimeForRemovingAbility && IsAbilityRemoved == false)
             {
                 RemoveAbility();
             }
